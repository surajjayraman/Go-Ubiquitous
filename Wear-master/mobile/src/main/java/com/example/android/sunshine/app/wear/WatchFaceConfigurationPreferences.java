...
public class WatchFaceConfigurationPreferences {
    ...
    public static WatchFaceConfigurationPreferences newInstance(Context context) {
        SharedPreferences preferences = context.getSharedPreferences(NAME, Context.MODE_PRIVATE);
        return new WatchFaceConfigurationPreferences(preferences);
    }

    WatchFaceConfigurationPreferences(SharedPreferences preferences) {
